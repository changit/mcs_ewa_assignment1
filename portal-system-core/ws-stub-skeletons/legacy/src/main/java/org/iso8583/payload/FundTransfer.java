...
public class FundTransfer {
    ...
    @XmlElementRef(name = "from", namespace = "http://iso8583.org/payload", type = JAXBElement.class)
    protected JAXBElement<String> from;
    @XmlElementRef(name = "to", namespace = "http://iso8583.org/payload", type = JAXBElement.class)
