...
public class ObjectFactory {
    ...
    public JAXBElement<String> createFundTransferResponseReturn(String value) {
        return new JAXBElement<String>(_GetBalanceResponseReturn_QNAME, String.class, FundTransferResponse.class, value);
    }
