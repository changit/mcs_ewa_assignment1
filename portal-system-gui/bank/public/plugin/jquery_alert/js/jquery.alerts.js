...
//		jPromptpwd( message, [value, title, callback] )
// 
// History:
//
...
(function($) {
	...
	$.alerts = {
		...
		promptpwd: function(message, value, title, callback) {
			if( title == null ) title = 'Promptpwd';
			$.alerts._show(title, message, value, 'promptpwd', function(result) {
				if( callback ) callback(result);
			});
		},
		...
		_show: function(title, msg, value, type, callback) {
			...
			$("BODY").append(
				'<div id="popup_background" style="width:100%; height:100%;">' +
				'</div>' + 
				'<div id="popup_container" style="width:420px; min-width:420px; max-width:420px; height:200px;">' +
	...
	jPromptpwd = function(message, value, title, callback) {
		$.alerts.promptpwd(message, value, title, callback);
	};
